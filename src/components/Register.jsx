...
const Register = () => {
      ...
      const onSubmit = async (e) => {
        ...
        const response = await axios.get('https://tranquil-forest-69520.herokuapp.com/users/validateRegister', { params : {username: username, email: email}})
        if (response.status === 200) {
          const res = await axios.post('https://tranquil-forest-69520.herokuapp.com/users/add', newUser)
